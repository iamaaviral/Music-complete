...
function changeCurrentSongDetails(
  songObj //function creat kiya ek argument pass kiya hai song object
) {
...
function addSongNameClickEvent(
  songObj,
  position //we have made a machine jispe 2 buttons diye hai songName and position ke liye
) {
...
window.onload = function() {
  ...
  for (
    var i = 0;
    i < songs.length;
    i++ //Var i zero se 3 tak chalana hai
  ) {
